  ...
  <span class="absolute w-86.05% top-[35%] left-[45%] inline-block tracking-[0.25px] text-center leading-[28px] text-white">
    ENTRAR
      ...
      <div class="absolute top-[144.9px] left-[1px] w-[556.1px] h-[96.2px]">
        ...
        <div
          class="absolute border-gray-300 w-[78.65%] top-[calc(50%_-_12px)] right-[17.68%] left-[8.67%] h-[50.1px] "
        >
        <input v-model="senha" class="absolute w-full top-[calc(50%_-_40.05px)] left-[0%] tracking-[0.25px] leading-[28px] inline-block h-[50.1px]" type="senha" placeholder="Senha">
